...
-- -----------------------------------------------------
-- Table `sentinelwarehousedb`.`Log-In`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sentinelwarehousedb`.`Log-In` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sentinelwarehousedb`.`Registre`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sentinelwarehousedb`.`Registre` (
  `id` INT NOT NULL,
  `dataEntrada` DATETIME NULL,
  `dataSortida` DATETIME NULL,
  `Log-In_id` INT NOT NULL,
  PRIMARY KEY (`id`, `Log-In_id`),
  INDEX `fk_Registre_Log-In1_idx` (`Log-In_id` ASC),
  CONSTRAINT `fk_Registre_Log-In1`
    FOREIGN KEY (`Log-In_id`)
    REFERENCES `sentinelwarehousedb`.`Log-In` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
